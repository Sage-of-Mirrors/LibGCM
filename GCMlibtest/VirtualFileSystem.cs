...
namespace GCMlibtest
{
    ...
    public sealed class VirtualFilesystemDirectory : VirtualFilesystemNode
    {
        ...
        public const string SysDataName = "&&SystemData";
        ...
        public VirtualFilesystemDirectory(string dirName)
            : base(NodeType.Directory, dirName)
        {
    ...
    public sealed class VirtualFilesystemFile : VirtualFilesystemNode
    {
        ...
        /// <summary>
        /// Absolute path of the file within the VFS.
        /// </summary>
        public string AbsoluteFilename
        {
            get { return m_absoluteFileName; }
            set
            {
                m_absoluteFileName = value;
                OnPropertyChanged("AbsoluteFileName");
            }
        }
        ...
        public VirtualFilesystemFile(string name, string extension, byte[] file)
            : base(NodeType.File, name)
        {
            Extension = extension;
            Data = file;
        }
